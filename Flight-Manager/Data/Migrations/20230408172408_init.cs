        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaneIdentificationNumber = table.Column<int>(type: "int", nullable: false),
                    ...
                    PriceNormal = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFlights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersFlights_AspNetUsers_dbUserId",
                        column: x => x.dbUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersFlights_Flights_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flights",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersFlights_dbUserId",
                table: "UsersFlights",
                column: "dbUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersFlights_FlightId",
                table: "UsersFlights",
                column: "FlightId");
        }
